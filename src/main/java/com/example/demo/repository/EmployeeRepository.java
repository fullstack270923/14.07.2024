...
public class EmployeeRepository {
    ...
    public Employee getEmployeeById(Integer id) {
        if (cacheRepositoryimpl.isKeyExist(String.valueOf(id))) {
            String emp_as_string = cacheRepositoryimpl.getCacheEntity(String.valueOf(id));
        ...
        try
        {
            Employee emp = jdbcTemplate.queryForObject(query, new EmployeeMapper(), id);
            cacheRepositoryimpl.createCacheEntity(String.valueOf(id), emp.toString());
            return emp;
        }
